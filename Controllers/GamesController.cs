...
namespace RelationsNaN.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,ReleaseYear,GenreId")] Game game)
        {
            ...
            ViewData["GenreId"] = new SelectList(_context.Genre, "Id", "Id", game.Name);
            return View(game);
        }
        ...
        public async Task<IActionResult> AddPlatform(int? id)
        {
            ...
            ViewBag["Platforms"] = new SelectList(_context.Platforms, "Id", "Name", game.Platforms);
            return View(game);
        }
        ...
        public async Task<IActionResult> RemovePlatform(int? id)
        {
            ...
            ViewBag["Platform"] = new SelectList(_context.Platforms, "Id", "Name", game.Platforms);
            return View(game);
        }
